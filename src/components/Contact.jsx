        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="grid gap-4 sm:gap-6">
              {[
                { icon: FaPhone, title: "Call Us", info: ["+91 9439468845"], color: "from-green-500 to-emerald-600" },
                { icon: FaWhatsapp, title: "WhatsApp", info: ["+91 9777816655"], color: "from-green-400 to-green-600" },
                { icon: FaEnvelope, title: "Email Us", info: ["sahooengineering01@gmail.com"], color: "from-blue-500 to-cyan-600" },
